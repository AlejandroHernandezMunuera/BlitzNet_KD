...
parser.add_argument("--dataset", default='voc07', choices=['voc07', 'voc12-train', 'voc12-val',
                                                           ...
                                                           'coco-seg','voc12-Main-train',
                                                           'voc12-Main-val', 'voc12-Main-trainval',
                                                           'voc12-Segmentation-train', 'voc12-Segmentation-val',
                                                           'voc12-Segmentation-trainval', 'voc12-SegmentationAug-train'])
...
data_augmentation_config = {
    ...
    'segmentation_tutor_softoutput_dim': 21,
}
